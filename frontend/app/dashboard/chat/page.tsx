...
export default function ChatPage() {
  ...
  .chat-wrap { 
    ...
    height: calc(100vh - 40px);   /* ← accounts for layout padding + page header */
    min-height: 400px;
  }
  .page-header { 
    display:flex; align-items:flex-start; justify-content:space-between; 
    margin-bottom:16px; flex-shrink:0; gap:20px; flex-wrap:wrap; 
  }
  ...
  .chat-box { 
    ...
    overflow:hidden;       /* ← clips children, not itself */
  ...
  .bubble { border-radius:16px; padding:12px 16px; font-size:14px; line-height:1.6; max-width:75%; word-break:break-word; }
  ...
  .file-chip { margin:0 16px 8px; background:rgba(192,132,252,0.1); border:1px solid rgba(192,132,252,0.2); border-radius:10px; padding:8px 14px; color:#c084fc; font-size:13px; display:flex; align-items:center; justify-content:space-between; flex-shrink:0; }
  ...
  .chat-input { flex:1; background:rgba(255,255,255,0.06); border:1px solid rgba(255,255,255,0.1); border-radius:14px; padding:10px 14px; color:#fff; font-size:14px; outline:none; resize:none; font-family:inherit; line-height:1.5; min-width:0; min-height:65px;}
  .chat-input:focus { border-color:rgba(192,132,252,0.4); }
  .chat-input::placeholder { color:rgba(255,255,255,0.25); }
  .send-btn { width:40px; height:40px; background:linear-gradient(135deg,#c084fc,#a855f7); color:#fff; border:none; border-radius:13px; cursor:pointer; font-size:18px; flex-shrink:0; }
