...
export default function TranslatePage() {
  ...
  const submit = async () => {
    ...
    fd.append("file", file);
    fd.append("user_context", JSON.stringify({ name: user.name, category: user.category, level: user.level, college: user.college }));
    try {
  ...
  return (
    <div>
      <div className="page-header">
        ...
        <p>Upload your notes or textbook page — Sahayak will translate line by line into Odia for <strong>{user?.category} {user?.level}</strong></p>
      </div>
