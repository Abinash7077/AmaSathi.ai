...
export default function Sidebar() {
  ...
  useEffect(() => {
    ...
    fetch(`${API}/api/auth/me`, {
      ...
      .then((me) => {
        if (me.detail) {
          localStorage.setItem("amasathi_kick_reason", "session_expired");
          router.push("/sign-in");
          return;
        }
    ...
    <>
      ...
      >
        ...
        <nav className="nav">
          ...
          {profile?.is_admin && (
            <Link
              href="/admin"
              className={`ni adm ${pathname === "/admin" ? "act" : ""}`}
            >
        ...
        {profile && (
          <div className="plan-wrap">
            ...
            <div className="plan-info">
              <span className="plan-name" style={{ color: pc.color }}>
                {pc.label}
              </span>
              ...
              {profile.plan === "free" && (
                <Link href="/profile?tab=plan" className="upg-btn">
                  Upgrade ↑
                </Link>
              )}
            </div>
        ...
        {profile && (
          <div className="user-wrap">
            ...
            <div className="uinfo">
              ...
              {profile.college && (
                <div className="ucollege">{profile.college}</div>
              )}
            </div>
          </div>
        )}
      ...
      <div className={`mob-drawer ${mobileOpen ? "open" : ""}`}>
        ...
        <Link href="/dashboard" className="logo" style={{ marginBottom: 8 }}>
          <span className="logo-ic">🎓</span>
          <span className="logo-tx" style={{ opacity: 1 }}>
            amasathi
          </span>
        </Link>
        <div className="sep" />
