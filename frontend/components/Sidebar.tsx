  ...
  return (
    <>
      ...
      <style jsx global>{`
        ...
        .plan-wrap {
          display: flex; align-items: center; gap: 10px;
          padding: 8px 6px; flex-shrink: 0; overflow: hidden;
        }
        .plan-ic {
        ...
        .plan-info {
          ...
          opacity: 0; transition: opacity 0.2s; overflow: hidden;
        }
        ...
        /* ── Actions ── */
        .acts { display: flex; flex-direction: column; gap: 2px;text-decoration:none;padding:8px,16px; }
        .abt {
          display: flex; align-items: center; gap: 12px;
          color: rgba(255,255,255,0.38); text-decoration: none;
